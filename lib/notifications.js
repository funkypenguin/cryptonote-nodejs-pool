...
function sendToDiscordChannel(id, variables) {
    ...
    if (config.email && config.email.enabled) {
        var subject = getDiscordSubject(id, variables);
        var color   = getDiscordColor(id, variables);
        discord.sendDiscord(subject, color);
    }
}
...
function getDiscordMessage(id, variables) {
    ...
    var message = replaceVariables(notificationSettings.discordMessage[id], discordVars) || '';
    return message;
}
